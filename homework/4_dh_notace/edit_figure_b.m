...
% SS0:
TB0 = dh_transform(0, -l(1), 0, pi/2);
T = TB0;
draw_coords(T, '0');

% SS1
T01 = dh_transform(0,0,0,pi);
T = T * rot_joint * T01;
draw_coords(T, '1');

% SS2
T12 = dh_transform(0, 0, l(3), 0);
T = T * trans_joint * T12;
draw_coords(T , '2');

% SS3
T23 = dh_transform(0, 0, l(4), pi);
T = T * rot_joint * T23;
draw_coords(T, '3');

% SS4
T34 = dh_transform(pi/2, 0, l(5), -pi/2);
T = T * rot_joint * T34;
draw_coords(T, '4');

% SS5
T45 = dh_transform(pi/2, -l(6), 0, -pi/2);
T = T * rot_joint * T45;
draw_coords(T, '5');

% SSW
T56 = dh_transform(0,0,l(7),pi/2);
T = T * rot_joint * T56;
draw_coords(T, '6');
